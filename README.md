...
* Install the repo dependencies ```pip3 install -r requirements.txt```
...
* Create a run.env file in the root that contains your OpenAI API Key ```OPENAI_API_KEY=yourkeyhere```
